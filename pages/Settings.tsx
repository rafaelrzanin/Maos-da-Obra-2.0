          ...
          return (
            ...
            >
              ...
              <p className="text-text-muted dark:text-slate-500 text-xs mb-8">
                  {isVitalicio ? 'Acesso vitalício à IA Zé da Obra e Bônus.' : 'Gestão completa da obra com teste do Zé.'}
              </p>
              ...
              <div className="flex-1 mb-8">
                 <ul className="space-y-4">
                    ...
                    {isVitalicio ? (
                        <>
                            <li className="flex items-start text-sm text-premium font-bold">
                                <i className="fa-solid fa-robot mt-0.5 mr-3"></i>
                                Zé da Obra AI Ilimitado
                            </li>
                            <li className="pt-2 border-t border-dashed border-slate-200 dark:border-slate-800">
                                <p className="text-[10px] uppercase font-bold text-slate-400 mb-2">3 Bônus Exclusivos:</p>
                                <ul className="space-y-2">
                                    <li className="flex items-center text-xs text-text-body dark:text-slate-300"><i className="fa-solid fa-calculator text-premium mr-2"></i> Calculadoras de Material</li>
                                    <li className="flex items-center text-xs text-text-body dark:text-slate-300"><i className="fa-solid fa-file-contract text-premium mr-2"></i> Gerador de Contratos</li>
                                    <li className="flex items-center text-xs text-text-body dark:text-slate-300"><i className="fa-solid fa-list-check text-premium mr-2"></i> Checklists de Obra</li>
                                </ul>
                            </li>
                        </>
                    ) : (
                        <li className="flex items-start text-sm text-text-body dark:text-slate-300">
                            <i className="fa-solid fa-clock mt-0.5 mr-3 text-secondary"></i>
                            Zé da Obra AI: Grátis por 7 dias
                        </li>
                    )}
                 </ul>
              </div>
